...
__all__ = ["mkdir", "nms", "multiclass_nms", "demo_postprocess", "assess_horizontal_or_vertical", "intersect", "ccw"]
...
def intersect(A, B, C, D): # determine whether line AB intersect line CD or not
    return ccw(A, C, D) != ccw(B, C, D) and ccw(A, B, C) != ccw(A, B, D)


def ccw(A, B, C): # counterclockwise function, determine whether they form a counterclockwise angle or not
